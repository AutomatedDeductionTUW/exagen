...
accessible online content for a diverse audience. Probably one of the hardest challenges %in this new form of education
...
first-order formulas with/without theories, that were further used in
...
\input{SMT_template.tex}



\subsection{Ground Superposition}\label{sec:qf}

\input{ground_sup_template.tex}\label{sec:gs}
