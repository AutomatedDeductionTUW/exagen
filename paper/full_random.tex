...
\todo{maybe this should go into the implementation section}

% If the restrictions on the resulting formulas are too strict
...
We also enumerated the sample space to see how much variety our criteria allow:
