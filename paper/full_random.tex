...
%For these problems, we generate instances randomly,
 ...
 hard/easy. Throughout this paper, we assume basic familiarity with standard first-order
...
%
%also known as \emph{contextual literal cutting}~\cite{Vampire13} and
...
simplification, and even generating, inferences, such as 
subsumption demodulation~\cite{Rath20}.\smallskip
...
TODO ADD: How many problems are there?
