...
\todo{Also add a link to the generated benchmarks.;
JR: They are actually in the same repo among the generated exams;
maybe we should add a README to explain (some of) the folder structure? (because that's displayed on the repo page)}
...
\todo{P: I added this to mention Section 5. Feel free to edit.}
