...
{{\Large\bf Final Exam {\small -- June 17, 2020}} \hfill {\small\it Version 2020-06-17 / {\InputIfExists{version.tex}\unskip}}}\\
\hrule\medskip}}
...
by the precedence \InputIfExists{sup-precedence.tex}
and the weight function $w$ with \InputIfExists{sup-weights.tex}\unskip.
...
where \InputIfExists{red-signature.tex}
%
\begin{itemize}
    \item[(a)]
